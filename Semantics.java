...
public class Semantics {
    ...
    State M (Statement s, State state) {
        ...
        throw new IllegalArgumentException("should never reach here sem");
    }
	...
	if (op.val.equals(Operator.INT_LT)) 
	 ...
	 if (op.val.equals(Operator.INT_GT)) 
		...
		//System.out.println ("int_ge called");
            return new BoolValue(v1.intValue( ) >= v2.intValue( ));	}
	// char comparison
	if (op.val.equals(Operator.CHAR_LT)) 
	 ...
	 if (op.val.equals(Operator.CHAR_GT)) 
        ...
        if (op.val.equals(Operator.CHAR_GE)) 
            return new BoolValue(v1.charValue( ) >= v2.charValue( ));	
	//boolean comparison	need to write function so that false < true
	if (op.val.equals(Operator.BOOL_LT))
		return new BoolValue (bool2int(v1.boolValue()) < bool2int(v2.boolValue()));
	...
	if (op.val.equals(Operator.OR))
        ...
        throw new IllegalArgumentException("should never reach here is it here");
    } 
    ...
    Value applyUnary (Operator op, Value v) {
        ...
        throw new IllegalArgumentException("should never reach here here maybe");
    } 
