...
public class TypeTransformer {
	...
	if (e instanceof Unary) {
		Unary u = (Unary) e;
		Type t1 = StaticTypeCheck.typeOf(u.term,tm);
		Expression t2 = T (u.term,tm);
		if (t1 == Type.INT)
			return new Unary(u.op.intMap(u.op.val) ,t2);
		else if (t1 == Type.FLOAT)
			return new Unary(u.op.floatMap(u.op.val) ,t2);
		else if (t1 == Type.BOOL)
			return new Unary(u.op.boolMap(u.op.val) ,t2);
	}	
